...
public class OrientationServiceTest extends SharedTest {
    ...
    public void calculateOrientations3Unique() {
        List<Orientation> orientations = orientationService.calculateOrientations(dimensionsFactory.create(2., 3., 4.));
    ...
    public void calculateOrientations2Unique() {
        List<Orientation> orientations = orientationService.calculateOrientations(dimensionsFactory.create(2., 2., 4.));
    ...
    public void calculateOrientations1Unique() {
        List<Orientation> orientations = orientationService.calculateOrientations(dimensionsFactory.create(2., 2., 2.));
